...
public class RobotContainer {
  ...
  public final static DoubleSupplier leftXAxis = () -> controller.getRawAxis(0);
  ...
  //private final moveMotor motorMove = new moveMotor(m_canSparkFlex);
  ...
  private void configureBindings() {
    ...
    //m_canSparkFlex.setDefaultCommand(motorMove);
